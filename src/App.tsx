...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/pre-visualization" element={<GuardedFeature featureId="pre_visualization"><Layout><PreVisualization /></Layout></GuardedFeature>} />
      ...
      <Route path="/casting-directory" element={<GuardedFeature featureId="casting_directory"><Layout><TalentDashboard /></Layout></GuardedFeature>} />
