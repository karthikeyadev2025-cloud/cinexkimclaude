...
export default function SysAdminLogin() {
  ...
  const [email, setEmail] = useState('cinexuniverse@gmail.com')
  const [password, setPassword] = useState('Karthi@cinex20252026')
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="cinexuniverse@gmail.com" disabled={lockoutActive}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••••••" disabled={lockoutActive}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showSecret ? 'text' : 'password'} value={secretKey} onChange={(e) => setSecretKey(e.target.value)} placeholder="Karthikeya@2025" disabled={lockoutActive}
                  className="w-full bg-[#111] border border-[#242424] rounded-lg pl-10 pr-10 py-2.5 text-sm font-inter text-[#F0F0F0] placeholder:text-[#555] focus:outline-none focus:border-[#D4A853]/40 disabled:opacity-40" />
              ...
              <p className="text-[10px] font-inter text-[#555] mt-1">Demo key: <span className="text-[#D4A853] font-mono">Karthikeya@2025</span></p>
            </div>
